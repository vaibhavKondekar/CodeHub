...
const RoomData = () => {
    ...
    const getData = async (item) => {
        loadingStart();
        await axios.get(`${config.BACKEND_URL + "/rooms/fetch"}?id=${item.roomid}`
            , {
                headers: {
    ...
    const createRoom = async () => {
        ...
        axios({
            method: 'post',
            url: config.BACKEND_URL + '/rooms/create',
            headers: {
                Authorization: `Bearer ${localStorage.getItem('user')}`
            },
            data: {
    ...
    const joinOtherRoom = async () => {
        ...
        axios({
            method: 'get',
            url: config.BACKEND_URL + `/rooms/fetch?id=${roomID}`,
            headers: {
                Authorization: `Bearer ${localStorage.getItem('user')}`
            }
        })
    ...
    const deleteData = (item) => async () => {
        ...
        axios({
            method: 'delete',
            url: config.BACKEND_URL + `/rooms/delete`,
            headers: {
                Authorization: `Bearer ${localStorage.getItem('user')}`
            },
            data: {
